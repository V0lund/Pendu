...
def assert_victoire(i: int, s: str) -> str:
    ...
    if i > 0 and '_' not in s:
        return 'Tres bien! Vous avais gagne!'
    else:
        return 'Domage! Vous avez perdu!'
...
if __name__ == '__main__':
    ...
    while c == True:
        ...
        if opt_uti == 'n':  # option pour jouer/rejouer le jeux
            ...
            print("Vous aveaz choisi d'ajouter un nouveau mot a la dictionnaire!")
            ajouter_mot_dico()
            sorter_dico()
        else:  # FIN du jeux
            print()
            print('Merci pour avez joue le PENDU! A bientot!')
            c = False
